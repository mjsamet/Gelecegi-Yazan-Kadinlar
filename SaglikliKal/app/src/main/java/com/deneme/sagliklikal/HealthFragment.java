...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView baslik = view.findViewById(R.id.textViewBaslik);
        TextView metin = view.findViewById(R.id.textViewMetin);

        SaglikliBilgilerRepository repo = ((App)view.getContext().getApplicationContext()).GetSaglikliBilgilerRepository();
        SaglikliBilgi bilgi = repo.GetSaglikliBilgi();
        if(bilgi != null){
            imageView.setImageResource(bilgi.getResim());
            baslik.setText(bilgi.getBaslik());
            metin.setText(bilgi.getMetin());
        }
        return view;
    }
